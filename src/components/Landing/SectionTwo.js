        ...
        <section className='bg-[#222222] relative z-20 py-20 px-6 lg:px-0'>
            <div className='w-full mx-auto max-w-max text-white flex flex-wrap justify-between'>
                <div className='w-full flex flex-col gap-0'>
                    ...
                    <div className='w-full lg:max-w-[80%] mt-5'>
                        <img src="/images/map.jpg" alt="map" className='h-[250px] object-cover' />
                    </div>
                    <div className=' h-full flex flex-col gap-0 lg:translate-y-[90%]'>
                        <Counts />
                        <p className='text-black uppercase text-lg'>Years in business</p>
                    </div>
                </div>
                <div className='w-full lg:max-w-[50%]'>
                    <p className='text-xl md:text-2xl mt-10 lg:mt-0 text-[#cccccc]'>
                        Welcome to Truebond Global Investment, where expertise meets opportunity. We
                        <span className='text-primaryOrange'>{" "}specialize{" "}</span >
                        in delivering diverse investment solutions designed to grow wealth,
