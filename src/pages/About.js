...
const About = () => {
    ...
    return (
        <section className='bg-black text-white flex flex-col justify-center items-center pt-40'>
            ...
            <h1 className='text-[50px] md:text-[60px] lg:text-[70px] tracking-[4px] text-center text-primaryOrange mt-5'>Global Investment <br /> Group</h1>
            <p className='text-[18px] md:text-[25px] text-center max-w-[800px] mt-10 font-light'>
                Truebond Global Investment is a premier investment firm committed to driving value across the financial spectrum
            </p>
            <div className='relative w-full max-w-[1200px] h-[600px] mx-auto mt-5 md:mt-10'>
            ...
            <p className='text-[25px] md:text-[30px] lg:text-[45px] leading-[45px] tracking-[2.5px] max-w-[1200px] text-center mt-10'>
            ...
            <div className='w-full relative  mt-20 ' style={{ backgroundImage: 'url(/images/earth2.jpg)', backgroundSize: 'cover' }}>
                <div className=' top-0 left-0 px-6 lg:px-0 bg-[#000000ca] py-20 w-full h-full flex flex-col gap-28'>
                    <div className='w-full max-w-[1000px] mx-auto flex flex-wrap lg:flex-nowrap items-center justify-between gap-10 '>
                        <div className='w-full lg:max-w-[50%] flex flex-col gap-4 lg:text-right'>
                    ...
                    <div className='w-full max-w-[1000px] mx-auto flex flex-wrap lg:flex-nowrap flex-row-reverse items-center justify-between gap-10 '>
                        <div className='w-full lg:max-w-[50%] flex flex-col gap-4 text-left'>
            ...
            <div className='py-20 w-full flex flex-col gap-14 items-center bg-primaryGray'>
                <h1 className='text-[40px] md:text-[50px] lg:text-[60px]'>Our Core Values</h1>
                <div className='flex flex-col lg:flex-row gap-[20px] md:gap-28px lg:gap-32'>
